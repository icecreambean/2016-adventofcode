...
# to learn (as with javafx...): classes, and proper oop
# this is a good starting example off reddit - i haven't seen the use of
# setattr and getattr before... should investigate how it works with
# 'parse' - sounds like "reflection"

# source: #https://www.reddit.com/r/adventofcode/comments/5hus40/2016_day_12_solutions/

# NOTE: NOT MY OWN CODE; SAVING THIS TO LEARN FROM LATER.
...
class BunnyInterpreter:
    ...
    def parse(self, ins):
        op, *args = ins.split()
        getattr(self, op)(*args) 		# <-- interesting...
        if op != 'jnz':
            self.pointer += 1
